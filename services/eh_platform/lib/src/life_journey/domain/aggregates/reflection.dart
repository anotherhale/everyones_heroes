...
import 'package:eh_platform/src/life_journey/domain/events/insights_generated.dart';
import 'package:eh_platform/src/life_journey/domain/events/narrative_themes_added.dart';
...
final class Reflection extends AggregateRoot<ReflectionId> {
  Reflection({
    ...
    DateTime? submittedAt,
       ...
       _responses = List.of(responses ?? const []),
       _insights = List.of(insights ?? const []),
       _behavioralEvidence = List.of(behavioralEvidence ?? const []),
       _narrativeThemes = List.of(narrativeThemes ?? const []),
       super(id);
