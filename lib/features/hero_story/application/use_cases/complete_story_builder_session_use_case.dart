...
/// Marks the session completed. Does not create a [Story] (SB.0 default).
final class CompleteStoryBuilderSessionUseCase
    implements UseCase<StoryBuilderSessionIdRequest, StoryBuilderSession> {
  const CompleteStoryBuilderSessionUseCase({
  ...
  Future<Result<StoryBuilderSession>> execute(
    ...
    try {
      ...
      return Failure('Failed to complete Story Builder session: $e');
    }
  }
}
