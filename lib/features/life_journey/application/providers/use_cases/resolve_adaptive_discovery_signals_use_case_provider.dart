...
import 'package:everyonesheroes/features/discovery/application/providers/ports/discovery_profile_theme_source_provider.dart';
...
final resolveAdaptiveDiscoverySignalsUseCaseProvider =
  ...
  return DefaultResolveAdaptiveDiscoverySignalsUseCase(
    ...
    discoveryProfileThemeSource: ref.read(discoveryProfileThemeSourceProvider),
  );
});
