...
/// Sets or clears Story Builder purpose without changing themes.
final class SetStoryBuilderPurposeUseCase
    implements UseCase<SetStoryBuilderPurposeRequest, StoryBuilderSession> {
  const SetStoryBuilderPurposeUseCase({
  ...
  Future<Result<StoryBuilderSession>> execute(
    SetStoryBuilderPurposeRequest request,
  ) async {
    try {
      ...
      return Failure('Failed to set Story Builder purpose: $e');
    }
  }
}
