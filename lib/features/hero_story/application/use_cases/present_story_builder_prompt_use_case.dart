...
final class PresentStoryBuilderPromptUseCase
    implements UseCase<PresentStoryBuilderPromptRequest, StoryBuilderSession> {
  const PresentStoryBuilderPromptUseCase({
  ...
  Future<Result<StoryBuilderSession>> execute(
    PresentStoryBuilderPromptRequest request,
  ) async {
    try {
      ...
      session.presentPrompt(request.prompt);
      ...
      return Failure('Failed to present Story Builder prompt: $e');
    }
  }
}
