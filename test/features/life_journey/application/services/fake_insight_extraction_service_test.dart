...
void main() {
  group('FakeInsightExtractionService', () {
    const service = FakeInsightExtractionService();
    ...
    test('returns empty when no responses exist', () async {
      ...
      final insights = await service.extractInsights(reflection);

      expect(insights, isEmpty);
    });

    test('returns insight when responses exist', () async {
      final reflection = Reflection.create(
        id: ReflectionId.generate(),
        journeyId: JourneyId.generate(),
      );
