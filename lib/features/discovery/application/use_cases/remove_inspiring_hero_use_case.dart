...
/// Removes an inspiring Hero from the current DiscoveryProfile (D.11).
///
/// ## Flow
///
/// ```text
...
///      ↓
/// DiscoveryProfile.removeInspiringHero
///      ↓
/// Repository.save
/// ```
///
...
final class RemoveInspiringHeroUseCase {
  ...
  /// Removes [heroId] from the current profile. Absent removals are idempotent.
