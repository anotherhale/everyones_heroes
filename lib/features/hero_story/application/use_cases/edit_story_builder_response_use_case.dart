...
final class EditStoryBuilderResponseUseCase
    implements UseCase<EditStoryBuilderResponseRequest, StoryBuilderSession> {
  const EditStoryBuilderResponseUseCase({
  ...
  Future<Result<StoryBuilderSession>> execute(
    EditStoryBuilderResponseRequest request,
  ) async {
    try {
      ...
      return Failure('Failed to edit Story Builder response: $e');
    }
  }
}
