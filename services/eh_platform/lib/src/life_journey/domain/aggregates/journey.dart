...
import 'package:eh_platform/src/shared_kernel/aggregate_root.dart';

import 'package:eh_platform/src/life_journey/domain/enums/journey_chapter.dart';
import 'package:eh_platform/src/life_journey/domain/events/behavior_patterns_detected.dart';

import 'package:eh_platform/src/life_journey/domain/events/chapter_advanced.dart';
import 'package:eh_platform/src/life_journey/domain/events/journey_created.dart';
...
final class Journey extends AggregateRoot<JourneyId> {
  Journey({
    ...
    List<BehaviorPattern>? behaviorPatterns,
       ...
       _activeQuestIds = List.of(activeQuestIds ?? const []),
       _behaviorPatterns = List.of(behaviorPatterns ?? const []),
       super(id);
